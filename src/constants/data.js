...
export const dealData = [
    ...
    { 
        id: 'product6',
        url: 'https://rukminim1.flixcart.com/image/150/150/kj0bp8w0-0/shoe/k/g/5/ttim-brd-300-rd-aura-coral-red-original-imafyz52kqfjeuxe.jpeg?q=70', 
        title: {
            shortTitle: 'Asian, Birde & more'
        }, 
        discount: 'Under 799', 
        tagline: 'Shoes, Sandal & more' 
    },

    { 
        id: 'product7',
        url: 'https://rukminim1.flixcart.com/image/150/150/knknc7k0/home-temple/1/2/m/332-big-tempal-son-mahavir-eco-products-original-imag27xrhb6ghujn.jpeg?q=70', 
        title: {
            shortTitle: 'Home Temples & more'
        }, 
        discount: 'Extra 10% Off', 
        tagline: 'Space Saving furniture' 
    },
